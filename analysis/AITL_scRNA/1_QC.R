...
data.path <- 'C:/Users/work/Desktop/R/obs_AITL/data/scRNAdata'
...
setwd('C:/Users/work/Desktop/R/obs_AITL/analyze/QC')
for(i in 1:length(violin_before)){
  print(violin_before[[i]])
  ggsave(filename = paste0(levels(violin_before[[i]][[1]][["data"]][["ident"]]),'QC_before.pdf'),width = 10,height = 10)
}
...
violin_after <- VlnPlot(scRNA_list,
                        ...
                        ncol = 4)
violin_after
ggsave('QC_after.pdf',width = 15,height = 10)
...
setwd('C:/Users/work/Desktop/R/obs_AITL/analyze')
dir.create('harmony')

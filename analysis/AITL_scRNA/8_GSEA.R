...
gene <- read.csv("result/TPHvsTFH(control).csv")
...
write.csv(GSEA_result,file = 'GSEA/TPHvsTFH(control)_GSEA_result.csv')
saveRDS(cluster_GSEA,file = 'GSEA/TPHvsTFH(control)_cluster_GSEA.rds')

#plot
cluster_GSEA <- readRDS('GSEA/TPHvsTFH(control)_cluster_GSEA.rds')
